...
def getInitialMatrix():
    ...
    del combined_df['movie_id_r']; del combined_df['user_id_t']; 
    #del combined_df['movie_id_t']; del combined_df['timestamp_t']
...
if __name__ == '__main__':
    ...
    users,items = runALS(A, R, n_factors = 3, n_iterations = 20, lambda_ = .1)
    print(users.shape,items.shape,A.shape)
